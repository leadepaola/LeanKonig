...
<?php 
	...
	//Toma de datos Productos individual add
	include('../php/productos/add/get_categorias.php');
?>
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				...
				$btn_volver_active=1;
				$descripcion_volver = 'Productos / Nuevo producto';
				include('base/btn_volver/btn_volver.php');

				include('productos/view_productos_individual_add.php');
			?>
