...
<?php
	...
	//Toma de datos mail confirmacion
	include('../php/mail_confirmacion/get_mail_confirmacion.php');
?>
...
<body>
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				$btn_volver_active=1;
				$descripcion_volver = 'Mail de confirmación';
				include('base/btn_volver/btn_volver.php');

				include('mail_confirmacion/view_mail_confirmacion.php');
			?>
