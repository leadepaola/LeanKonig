...
<?php 
	...
	//Toma datos Mercado Pago (parte 1)
	include('../../server_local/mercado_pago/composer/vendor/autoload.php');
	include('../../server_local/mercado_pago/credenciales.php');

	//Toma de datos maths 
	include('../php/sumar_dias/get_maths.php');
	include('../php/sumar_dias/get_sumar_dias_pago.php');

	//Toma datos Mercado Pago (parte 2)
	include('../../server_local/mercado_pago/links_d_regreso.php');
...
<body>
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				$btn_volver_active=1;
				$descripcion_volver = 'Sumar días / '.$titulo;
				include('base/btn_volver/btn_volver.php');

				include('sumar_dias/view_sumar_dias_pago.php');
			?>
