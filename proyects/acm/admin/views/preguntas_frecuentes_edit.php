...
<?php 
	...
	//Toma de datos preguntas precuentes
	include('../php/preg_frecuentes/get_preg_frecuentes_edit.php');
?>
	...
	<section class="seccion_d_trabajo_gral">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				...
				$btn_volver_active=1;
				$descripcion_volver = 'Preguntas frecuentes / Editar pregunta';
				include('base/btn_volver/btn_volver.php');

				include('preg_frecuentes/view_preg_frecuentes_edit.php');
			?>
