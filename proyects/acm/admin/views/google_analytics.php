...
<?php
	...
	//Toma de datos mapa
	include('../php/google_analytics/get_google_analytics.php');
?>
		...
		<div class="work_gral padding_gral_pc">
			...
			<span id="mapa_titulo_switch_cont">
				...
				<div class="switch switch_titulo">
					<label>
				    	<?php echo $html_inputs_google_analytics ?>
			...
			<?php
				$btn_volver_active=1;
				$descripcion_volver = 'Google Analytics';
				include('base/btn_volver/btn_volver.php');

				include('google_analytics/view_google_analytics.php');
			?>
