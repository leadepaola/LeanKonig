...
<?php
	...
	//Toma de datos Descuento
	include('../php/descuento/get_descuento.php');
?>
...
<body>
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<span id="descuento_titulo_switch_cont">
			...
			<?php
				$btn_volver_active=1;
				$descripcion_volver = 'Descuento';
				include('base/btn_volver/btn_volver.php');

				include('descuento/view_descuento.php');
			?>
