...
<?php 
	...
	//Toma de datos Color principal
	include('../php/color/get_color.php');
	...
	<section class="seccion_d_trabajo_gral">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				...
				$btn_volver_active=1;
				$descripcion_volver = 'Sin días disponibles';
				include('base/btn_volver/btn_volver.php');

				include('sumar_dias/view_sumar_dias_msj_sin_dias.php');
			?>
