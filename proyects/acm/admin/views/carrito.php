...
<?php 
	...
	include('../php/carrito/get_carrito.php');
...
<body>
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<span id="logo_titulo_switch_cont">
				...
				<div class="switch switch_titulo">
					<label>
				    	...
				    	<input type="checkbox"  id="checkbox_logo_active" <?php echo $html_checbox_active ?> >
			...
			<?php
				$btn_volver_active=1;
				$descripcion_volver = 'Carrito';
				include('base/btn_volver/btn_volver.php');

				include('carrito/view_carrito.php');
			?>
