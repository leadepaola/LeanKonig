...
<form class="row max_w_700 ped_gral_filtros_cont" <?php echo 'action="../php/metricas/contabilizar_pedidos/get_pedidos_filtros.php'.$codigo_id_web.'"' ?> method="post">
...
<div class="pedidos_gral_productos_cont max_w_700">
	<div class="row">
		...
		<?php
			...
			$metric_contab_action = 'action="contabilizar_pedidos_result.php'.$codigo_id_web.'"'; 
		?>
