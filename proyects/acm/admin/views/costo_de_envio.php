...
<?php 
	...
	//Toma de datos costo_d_envio
	include('../php/costo_d_envio/get_costo_d_envio.php');
?>
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				...
				$btn_volver_active=1;
				$descripcion_volver = 'Costo de Envío';
				include('base/btn_volver/btn_volver.php');

				include('costo_d_envio/view_costo_d_envio.php');
			?>
