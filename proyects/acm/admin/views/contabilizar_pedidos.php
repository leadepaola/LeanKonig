...
<?php 
	...
	include('../php/metricas/contabilizar_pedidos/get_pedidos.php');
...
<body>
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				$btn_volver_active=1;
				$descripcion_volver = 'Contabilizar pedidos';
				include('base/btn_volver/btn_volver.php');

				include('contabilizar_pedidos/view_contabilizar_pedidos.php');
			?>
