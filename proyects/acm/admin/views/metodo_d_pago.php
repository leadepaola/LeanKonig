...
<?php 
	...
	//Toma de datos Metodo de pago
	include('../php/metodo_d_pago/get_metodo_d_pago.php');
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				...
				$btn_volver_active=1;
				$descripcion_volver = 'Métodos de pago';
				include('base/btn_volver/btn_volver.php');

				include('metodo_d_pago/view_metodo_d_pago.php');
			?>
