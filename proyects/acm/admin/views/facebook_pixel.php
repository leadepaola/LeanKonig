...
<?php
	...
	//Toma de datos mapa
	include('../php/facebook_pixel/get_facebook_pixel.php');
?>
		...
		<div class="work_gral padding_gral_pc">
			...
			<span id="mapa_titulo_switch_cont">
				...
				<div class="switch switch_titulo">
					<label>
				    	<?php echo $html_inputs_facebook_pixel ?>
			...
			<?php
				$btn_volver_active=1;
				$descripcion_volver = 'Facebook Pixel';
				include('base/btn_volver/btn_volver.php');

				include('facebook_pixel/view_facebook_pixel.php');
			?>
