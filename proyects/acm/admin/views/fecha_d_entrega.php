...
<?php 
	...
	//Toma de datos Fechas de entrega
	include('../php/fecha_d_entrega/get_fecha_d_entrega.php');
	...
	<section class="seccion_d_trabajo_gral ">
		...
		<div class="work_gral padding_gral_pc">
			...
			<?php
				...
				$btn_volver_active=1;
				$descripcion_volver = 'Fecha de entrega';
				include('base/btn_volver/btn_volver.php');

				include('fecha_d_entrega/view_fecha_d_entrega.php');
			?>
