...
$name_new_img 		= $_FILES['img_form_mob']['name'];
...
unlink($carpeta_destino_cpanel_banner_duo_mob.$name_img_actual);



$sql = 'UPDATE ti_banners SET 

mob_nombre_'.$num_banner.' 		= "'.	$name_new_img_fyh		.'"
...
if ($result_->execute()) {
	...
	move_uploaded_file($_FILES['img_form_mob']['tmp_name'], $carpeta_destino_cpanel_banner_duo_mob.$name_new_img_fyh );
