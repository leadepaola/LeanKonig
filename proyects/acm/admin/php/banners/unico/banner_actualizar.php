...
$name_new_img 		= $_FILES['img_form']['name'];
...
unlink($carpeta_destino_cpanel_banner_unico.$name_img_actual);



$sql = 'UPDATE ti_banners SET 

unic_nombre_'.$num_banner.' 	= "'.	$name_new_img_fyh		.'"
...
if ($result_->execute()) {
	...
	move_uploaded_file($_FILES['img_form']['tmp_name'], $carpeta_destino_cpanel_banner_unico.$name_new_img_fyh );
