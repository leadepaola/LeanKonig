...
$sql_ = 'SELECT * FROM ti_fecha_d_entrega 
	...
	while($fila_ = $result_->fetch(PDO::FETCH_ASSOC)){
		...
		<div class="col s12">
			...
			<div class="input-field col s7 m8">
	        	<input class="index_input_editlea" type="text" value="'.$fila_['fecha'].'">
	        </div>
			...
			<div class="col s2 m1  index_item_switch">
				...
				<div class="switch ">
					<label class="label_checkbox">
				    	...
				    	<input type="hidden" id="id_fecha" 	name="id_fecha"	value="'.$fila_['id'].'"	>
