...
// para activar o desactivar descuento
...
$('#checkbox_tit_active').click(function(){
	...
	if ($('#checkbox_tit_active').is(':checked')) {
		...
		$.when(descuento_activar(id_web,id_cliente)).done(function () {   

		});

	}else{

		$.when(descuento_desactivar(id_web,id_cliente)).done(function () {   
...
function descuento_activar(id_w,id_c){
 
  var deferred = $.Deferred();

  $.ajax({
    "method": "POST",
    "url": "../php/descuento/descuento_activar.php",
    "data": {
...
function descuento_desactivar(id_w,id_c){
 
  var deferred = $.Deferred();

  $.ajax({
    "method": "POST",
    "url": "../php/descuento/descuento_desactivar.php",
    "data": {
              id_web:id_w,id_cliente:id_c
            }
  })   
...
function enviar_data(id_w,id_c,data_1){
  ...
  $.ajax({
    "method": "POST",
    "url": "../php/descuento/descuento_actualizar.php",
    "data": {
              id_web:id_w,id_cliente:id_c,
              data_1:data_1
            }
