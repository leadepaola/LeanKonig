...
$('#checkbox_tit_active').click(function(){
	...
	if ($('#checkbox_tit_active').is(':checked')) {
		...
		$.when(google_analytics_activar(id_web,id_cliente)).done(function () {   

		});

	}else{

		$.when(google_analytics_desactivar(id_web,id_cliente)).done(function () {   
...
function google_analytics_activar(id_w,id_c){
 
  var deferred = $.Deferred();

  $.ajax({
    "method": "POST",
    "url": "../php/google_analytics/google_analytics_activar.php",
    "data": {
...
function google_analytics_desactivar(id_w,id_c){
 
  var deferred = $.Deferred();

  $.ajax({
    "method": "POST",
    "url": "../php/google_analytics/google_analytics_desactivar.php",
    "data": {
              id_web:id_w,id_cliente:id_c
            }
  })   
...
function enviar_data(id_w,id_c,new_iframe){
  ...
  $.ajax({
    "method": "POST",
    "url": "../php/google_analytics/google_analytics_new_iframe.php",
    "data": {
              id_web:id_w,id_cliente:id_c,
