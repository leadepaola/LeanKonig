...
$(".contacto_icon.1").click(function(){
  ...
  if (dato_1==0) {
    ...
    $(".icon_contacto_size.1").css("color",  "rgb(220, 196, 231)");
...
$(".contacto_icon.2").click(function(){
  ...
  if (dato_2==0) {
    ...
    $(".icon_contacto_size.2").css("color",  "rgb(220, 196, 231)");
...
$(".contacto_icon.3").click(function(){
  ...
  if (dato_3==0) {
    ...
    $(".icon_contacto_size.3").css("color",  "rgb(220, 196, 231)");
...
$(".contacto_icon.4").click(function(){
  ...
  if (dato_4==0) {
    ...
    $(".icon_contacto_size.4").css("color",  "rgb(220, 196, 231)");
...
$(".contacto_icon.5").click(function(){
  ...
  if (dato_5==0) {
    ...
    $(".icon_contacto_size.5").css("color",  "rgb(220, 196, 231)");
...
boton_abrir_datos_contacto

boton_datos_activo = 0;


$("#boton_abrir_datos_contacto").click(function(){
    
  if (boton_datos_activo==0) {

    $("#contenedor_datos_contacto").css("display",  "block");

    //$("#contenedor_datos_contacto").css("left",  "10%");


    $("#boton_abrir_datos_contacto").html("Ocultar datos");
    //$("#boton_abrir_datos_contacto").css("left",  "-13%");
    //$("#boton_abrir_datos_contacto").css("width",  "120%");

    setTimeout(function(){ 
      boton_datos_activo=1;
    },100);
  }

  else{
    $("#contenedor_datos_contacto").css("display",  "none");

    //$("#contenedor_datos_contacto").css("left",  "-80%");

    $("#boton_abrir_datos_contacto").html("Mostar datos");
    //$("#boton_abrir_datos_contacto").css("left",  "100%");
    //$("#boton_abrir_datos_contacto").css("width",  "60%");
